...
# docker run -i --rm --net redis_cluster_net redis:5-alpine3.8 redis-cli --cluster create 172.26.0.2:6379 172.26.0.3:6379 172.26.0.4:6379 172.26.0.5:6379 172.26.0.6:6379 172.26.0.7:6379  --cluster-replicas 1;
